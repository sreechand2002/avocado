...
const MobileHeader = () => {
    ...
    const Items = [
        { key: 'home', text: <span><Icon name='home' />Home</span> },
        { key: 'about', text: <span><Icon name='users' />About Us</span> },
        { key: 'services', text: <span><Icon name='home' />Services</span> },
        { key: 'contact-us', text: <span><Icon name='phone square' />Contact-Us</span> },
    ]
